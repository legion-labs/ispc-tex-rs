...
pub mod kernel {
    ...
    fn bindgen_test_layout_bc6h_enc_settings() {
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<bc6h_enc_settings>())).refineIterations_1p as *const _
                    as usize
            },
            4usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<bc6h_enc_settings>())).refineIterations_2p as *const _
                    as usize
            },
            8usize,
            concat!(
    ...
    fn bindgen_test_layout_bc7_enc_settings() {
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<bc7_enc_settings>())).mode_selection as *const _ as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<bc7_enc_settings>())).fastSkipTreshold_mode1 as *const _
                    as usize
            },
            40usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<bc7_enc_settings>())).fastSkipTreshold_mode3 as *const _
                    as usize
            },
            44usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<bc7_enc_settings>())).fastSkipTreshold_mode7 as *const _
                    as usize
            },
            48usize,
            concat!(
